...
public class WalletDaoImpl implements WalletDao {
	...
	/*
	 * A single function for all the deposit,withdraw,fund transfer,edit-profile
	 * options In all the operations balance or other details are set in service
	 * layer itself and calls dao layer just to update (merge) it to existing
	 * database. So instead of writing all those functions,this is enough
	 */
	@Override
	...
	/*
	 * Method:getAllUsers Description: Used in admin page to view all the existing
	 * account details
	 * 
	 * @param: none
	 * 
	...
	public List<Account> getAllUsers() throws ResourceNotFoundException {
		try {
			// retrieving a list of all the existing users in the database for admin page
			// view
	...
	/*
	 * Method:geenerateAcntNumb Description: Used generate a new account number
	 * whenevr a new account is created
	 * 
	 * @param: none
	 * 
	...
	public long generateAcntNumb() {
		...
		if (count > 0) {
			// retrieving the maximum existing account number and setting the next value to
			// current new account
	...
	/*
	 * Method:geenerateTransactionId Description: Used generate a new transaction id
	 * whenever a new transaction is made
	 * 
	...
	public int generateTransactionId() {
		...
		String command = "SELECT count(t) from BuddyTransactions t";
		TypedQuery<Long> query = entityManager.createQuery(command, Long.class);
		long count = query.getSingleResult();

		if (count > 0) {
			// retrieving the maximum existing transaction id and setting the next value to
			// current new account
			command = "SELECT max(t.id) from BuddyTransactions t";
	...
	/*
	 * Method:createAccount Description: Used to persist or add a new account into
	 * data table whenever a new account is created
	 * 
	 * @param: none
	 * 
	 * @return void: none
	...
	/*
	 * Method:getAccount Description: Used to know an account details using it's
	 * account number
	 * 
	...
	/*
	 * Method:findAccount Description: Used to know any account exists with a
	 * particular user name during signup
	 * 
	...
	public boolean findAccount(String user) {
		...
		// As user name must be unique, retrieving data and returning boolean true if no
		// account found
	...
	/*
	 * Method:printTransactions Description: Used in e-statement page to view the
	 * transaction history from that wallet
	 * 
	 * @param long: Account number about which transactions need to be returned
	 * 
	 * @return List<Transactions>: a List of all the transactions made from that
	 * wallet
	 * 
	 * @throws ResourceNotFoundException: It is raised when no data found
	 */
	@Override
	public List<BuddyTransactions> printTransactions(long acNum) throws ResourceNotFoundException {

		try {
			// retrieving a list all the transactions performed by that account numbers
			Account account = getAccount(acNum);
			List<BuddyTransactions> list = account.getTransactions();
	...
	/*
	 * Method:login Description: Used in login page to access one's account by
	 * logging in
	 * 
	 ...
	 * 
	 * @return long: respective Account Number if credentials are correct so that it
	 * is possible for further references
	 * 
	 * @throws ResourceNotFoundException: It is raised when no data found
	 * 
	 * @throws InvalidLoginCredentialsException: It is raised when an user enters an
	 * incorrect user name or password
	 * 
	 * @throws AccountBlockedException: It is raised when an user account is blocked
	 * by admin and that user tries to login
	 */
	@Override
	public long login(String userName, String password)
			throws InvalidLoginCredentialsException, AccountBlockedException {
		// for login purpose checking whether the credentials entered are valid or
		// invalid
		// if valid, returning the account number to angular service for storing and
		// using for further references
	...
	/*
	 * Method:getAllBeneficiaries Description: Used in manageBeneficiary page &
	 * fundTransfer page to view all the beneficiaries existing with that account
	 * 
	 * @param long: Account number of that account whose beneficiaries need to be
	 * viewed
	 * 
	 * @return List<Beneficiary>: a List of all beneficiaries linked to that account
	 * is returned
	 * 
	 * @throws ResourceNotFoundException: It is raised when no data found
	 */
	...
	/*
	 * Method:deleteBeneficiary Description: Used in manageBenficiary page to delete
	 * an existing beneficiary linked to that account
	 * 
	 * @param int: beneficiaryId which is to be deleted
	 * 
	 * @return boolean: boolean 'true' is returned if beneficiary is deleted
	 * successfully else 'false'0
	 * 
	 * @throws ResourceNotFoundException: It is raised when no data found
	 * 
	 * @throws UnknownErrorException: It is raised when some unexpected error or
	...
	/*
	 * Method:generateBeneficiaryId Description: Used generate a new beneficiary id
	 * whenever a new beneficiary is added
	 * 
	...
	public int generateBeneficiaryId() {
		...
		if (count > 0) {
			// retrieving the maximum existing beneficiary id and setting its next value to
	...
	/*
	 * Method:findBeneficiary Description: Used to get the details of an beneficiary
	 * using that respective beneficairyId
	 * 
	 * @param int: beneficiaryId whose details are needed
	 * 
	 * @return Beneficiary: a Beneficiary object containing all the details of that
	 * beneficiaryId
	 */
	@Override
	...
	/*
	 * Method:generateMailId Description: Used to generate a new Mail id whenever a
	 * new mail, feedback or complaint is added
	 * 
	...
	/*
	 * Method:addMail Description: Used in feedback, contactUs and reportIssue pages
	 * to add a new feedback,mail or complaint
	 * 
	 * @param Mails: a Mails Object containing all the details of new feedback, mail
	 * or complaint
	 * 
	 * @return boolean: boolean 'true' is returned if mail,feedback or complaint is
	 * added successfully else 'false'0
	 * 
	 * @throws UnknownErrorException: It is raised when some unexpected error or
	 * exception occurs during the process
	 */
	...
	/*
	 * Method:getAllMails Description: Used in admin_Mails page to view all the
	 * feedbacks, mails and complaints
	 * 
	 * @param: none
	 * 
	 * @return List<Mails>: a List of all the existing feedbacks, mails and
	 * complaints is returned
	 * 
	 * @throws ResourceNotFoundException: It is raised when no data found
	 */
	@Override
